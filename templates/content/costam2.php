...
<tr>
<td>Komentarz</td>
<td><input type="text" name="comment" value="" size="40"></td>
</tr>
<tr>
...
if(isset($_POST['oblicz'])){
	...
	if(!is_numeric($oprocentowanie)){
		echo 'dane niepoprawne, wstaw liczbę w polu oprocentowanie. Uzyj "." w celu podania ulamka.';
		echo '</body></html>';
		exit;
	}
...
if(isset($_POST['oblicz_lokate'])){
	...
	$csvsource = $_POST["comment"];
	$rodzaj_kap = $_POST["rodzaj_kapitalizacji"];
	if(!is_numeric($oprocentowanie_lok)){
		  echo 'dane niepoprawne, wstaw liczbę w polu oprocentowanie. Uzyj "." w celu podania ulamka.';
                echo '</body></html>';
                exit;
	}
